      ...
      : SvgBaseElement
    {
          ...
          : base(document, parent, drawableBaseElement)
        {
            ...
            if (stroke_linecap_attribute != null)
                switch (stroke_linecap_attribute.Value.Trim())
                {
                    case "butt":
            ...
            if (stroke_linejoin_attribute != null)
                switch (stroke_linejoin_attribute.Value.Trim())
                {
                    case "miter":
            ...
            {
                if (stroke_miterlimit_attribute.Value.Trim() == "inherit")
            ...
            {
                if (stroke_dasharray_attribute.Value.Trim() == "none")
                    StrokeDasharray = null;
                else if (stroke_dasharray_attribute.Value.Trim() == "inherit")
            ...
            if (display_attribute != null)
                switch (display_attribute.Value.Trim())
                {
                    case "inline":
            ...
            if (fill_rule_attribute != null)
                switch (fill_rule_attribute.Value.Trim())
                {
                    case "nonzero":
